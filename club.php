...
if (isset($_POST['delete'])) {
	mysqli_query($link, "DELETE FROM card WHERE id={$_POST['delete']}");
}
...
<body>
	...
	<div class="container mt-5">
		<table class="table table-striped">
			...
			<tbody>
				<?php 
				$visits = mysqli_query($link, "SELECT * FROM card");
				...
				while ($row = mysqli_fetch_array($visits)) {
					...
					echo "<td><button class='btn btn-dark'type='submit' name='delete' value='{$row[0]}'>Видалити</button></td>";
					echo "</form>";
					echo "</tr>";
				}
				?>
