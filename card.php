...
if (isset($_POST['enter'])) {
	mysqli_query($link, "INSERT INTO card VALUES(NULL, '{$_POST['card']}', '{$_POST['csv']}', '{$_POST['name']}')");
}
?>
<!DOCTYPE html>
<html>
			...
			<div class="collapse navbar-collapse" style="padding-right: 0px!important;" id="navbarNavDropdown">
				<ul class="navbar-nav" style="font-size: 1.1em;">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle text-white hov px-0" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							Тренування
						</a>
...
<div class="container mb-5">
	<div class="row">
		<h3 class="text-center"> Клубна картка </h3>
		<p class="text-center mt-4">Клубна картка дозволить вам відвідувати тренування 3 рази на тиждень безкоштовно та в будь-який час без запису. Ціна клубної картки складає 1000грн на рік. Вам не обов'язкого приходити до клубу для оформлення картки. Все що необхідно це ввести дані у форму. Після чого ви зможете забрати свою картку в клубі в будь-який час.</p>
	</div>
</div>
	...
	<div class="containe preload mx-auto">
		<div class="creditcard">
			<div class="front">
				...
				<g id="Front">
					...
					<text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">Vdovichenko Makar</text>
		...
		<div class="back">
			...
			<g id="Back">
				...
				<text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">Вдовиченко Макар</text>
			</g>
		</svg>
	</div>
</div>
	...
	<div class="containe mx-auto">
		<div class="form-container">
			<div class="field-container">
				<label for="name">ПІБ Власника</label>
				<input id="name" maxlength="20" type="text" name="name">
			</div>
			<div class="field-container">
				<label for="cardnumber">Номер карты</label><span id="generatecard">Створити випадкову</span>
				<input id="cardnumber" type="text" name="card">
		...
		<div class="field-container">
			<label for="expirationdate">Дійсна до (mm/yy)</label>
			<input id="expirationdate" type="text">
		</div>
		<div class="field-container">
			<label for="securitycode">CSV</label>
			<input id="securitycode" type="text" name="csv">
		</div>
			<button id="first" class="btn btn-secondary my-3" style="width: 100%;" name="enter">Ввести</button>
...
name.addEventListener('input', function () {
	if (name.value.length == 0) {
		document.getElementById('svgname').innerHTML = 'Вдовиченко Макар';
		document.getElementById('svgnameback').innerHTML = 'Вдовиченко Макар';
	} else {
...
<script type="text/javascript">
	...
	document.getElementById('first').onclick = function(){
		alert("Дякуэмо за придбання картки нашого клубу. Вы не розчаруєтеся!");
	}
</script>
