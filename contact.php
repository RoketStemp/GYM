		...
		<div class="container" style="background-color: rgba(0, 0, 0,0.8)">
			...
			<div class="collapse navbar-collapse" style="margin-left: 1%; padding-right: 0px!important;" id="navbarNavDropdown">
				<ul class="navbar-nav">
					...
					<li class="nav-item" style="margin-left:7%;">
						<a class="nav-link text-white act hov" href="contact.php">Контакти</a>
					</li>
					<li class="nav-item" style="margin-left:7%;">
		...
		<div class="container">				
			<div class="contact-grids">
				<div class="col-md-8 map">
					<h3>Як нас знайти</h3>
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1365.1687193613695!2d33.482559254955284!3d46.81735587914026!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40c39cbaa6496809%3A0x59a0cdbee399fb35!2sGrand!5e0!3m2!1sru!2sua!4v1622542852744!5m2!1sru!2sua" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
				</div>
				<div class="col-md-4 address">
					<h3>Контаки</h3>
					<p class="cnt-p">Залиште заявку знизу або зателефонуйте нам, щоб отримати відповідь на будь-яке ваше запитання</p>
					<p>Тренажерний зал грант</p>
					<p>вулиця Велика Куликовська, 118, Каховка</p>
					<p>Телефон : +38 097 345 1243</p>
					<p>Email : <a href="mailto:stemproket@gmail.com">stemproket@gmail.com</a></p>
				</div>									
				<div class="clearfix"> </div>	
			</div>
			<div class=" contact-form">
				<h3>Залите ваше повідомлення</h3>
				<form method="POST">
					<div class="col-md-6 form-grids">
						<input type="text" value="Ім'я" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
						<input type="email" value="Пошта" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
						<input type="text" value="Телефон" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Telephone';}" required="">
					</div>
					<div class="col-md-6 form-grids">
						<textarea onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message...';}" required="">Ваще повідомлення</textarea>	
